...
function PrivacyPolicy() {
  return (
    <div id="main-content" className={styles.mainContent}>
      ...
      <h3>
        Notice: This is a third party tool developed independently of relevant
        2022 and Power to Change - Students
      </h3>
      <h2>Preface</h2>
      <p>
      ...
      <p>
        ...
        <a href="https://relevant-pfp.herokuapp.com/">
          https://relevant-pfp.herokuapp.com/
        </a>
      ...
      <p>
        ...
        website (or more specifically Facebook's plugin) uses these "cookies" to
      ...
      <p>
        I employ a heroku server to run this website (just to serve the
        webpage). Facebook's api is also implemented to allow for automatic
